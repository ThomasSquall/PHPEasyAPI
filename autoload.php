...
require_once dirname(__FILE__) . "/src/Enrichment/HeaderAnnotation.php";
require_once dirname(__FILE__) . "/src/Enrichment/JSONAnnotation.php";
require_once dirname(__FILE__) . "/src/Enrichment/UserAnnotation.php";